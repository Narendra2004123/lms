...
import {
  ...
  hasModifierKey
} from "./chunk-ZIPDEQ3R.js";
import {
  Directionality
} from "./chunk-64VZM3DN.js";
...
var MatPaginatedTabHeader = class _MatPaginatedTabHeader {
  ...
  ngAfterContentInit() {
    ...
    const resize = this._sharedResizeObserver.observe(this._elementRef.nativeElement).pipe((0, import_operators4.debounceTime)(32), (0, import_operators4.takeUntil)(this._destroyed));
    const viewportResize = this._viewportRuler.change(150).pipe((0, import_operators4.takeUntil)(this._destroyed));
    const realign = () => {
    ...
    (0, import_rxjs4.merge)(dirChange, viewportResize, resize, this._items.changes, this._itemsResized()).pipe((0, import_operators4.takeUntil)(this._destroyed)).subscribe(() => {
      this._ngZone.run(() => {
  ...
  _itemsResized() {
    ...
    return this._items.changes.pipe(
      (0, import_operators4.startWith)(this._items),
      (0, import_operators4.switchMap)((tabItems) => new import_rxjs4.Observable((observer) => this._ngZone.runOutsideAngular(() => {
      ...
      (0, import_operators4.skip)(1),
      // Skip emissions where all the elements are invisible since we don't want
      // the header to try and re-render with invalid measurements. See #25574.
      (0, import_operators4.filter)((entries) => entries.some((e) => e.contentRect.width > 0 && e.contentRect.height > 0))
    );
  }
  ...
  _handlePaginatorPress(direction, mouseEvent) {
    ...
    this._stopInterval();
    (0, import_rxjs4.timer)(HEADER_SCROLL_DELAY, HEADER_SCROLL_INTERVAL).pipe((0, import_operators4.takeUntil)((0, import_rxjs4.merge)(this._stopScrolling, this._destroyed))).subscribe(() => {
      const {
        maxScrollDistance,
        distance
      } = this._scrollHeader(direction);
...
var MatTabBodyPortal = class _MatTabBodyPortal extends CdkPortalOutlet {
  ...
  ngOnInit() {
    super.ngOnInit();
    this._centeringSub = this._host._beforeCentering.pipe((0, import_operators4.startWith)(this._host._isCenterPosition())).subscribe((isCentering) => {
...
var MatTabGroup = class _MatTabGroup {
  ...
  _subscribeToAllTabChanges() {
    this._allTabs.changes.pipe((0, import_operators4.startWith)(this._allTabs)).subscribe((tabs) => {
...
var MatTabNav = class _MatTabNav extends MatPaginatedTabHeader {
  ...
  ngAfterContentInit() {
    this._inkBar = new MatInkBar(this._items);
    this._items.changes.pipe((0, import_operators4.startWith)(null), (0, import_operators4.takeUntil)(this._destroyed)).subscribe(() => this.updateActiveLink());
    super.ngAfterContentInit();
  }
  ngAfterViewInit() {
...
var MatTabLink = class _MatTabLink extends InkBarItem {
  ...
  constructor() {
    ...
    this._tabNavBar._fitInkBarToContent.pipe((0, import_operators4.takeUntil)(this._destroyed)).subscribe((fitInkBarToContent) => {
